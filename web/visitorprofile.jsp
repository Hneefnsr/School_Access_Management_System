<%-- 
    Document   : visitorprofile
    Created on : Jan 7, 2024, 12:33:40 AM
    Author     : usee
--%>
    ...
    <body>
        <%
            ...
            if (Email != null) {
                try {
                    ...
                    PreparedStatement ps = con.prepareStatement("SELECT * FROM visitor WHERE visitorEmail = ? ");
                    ps.setString(1, Email);
                    ResultSet rs = ps.executeQuery();

                    if (rs.next()) {
                        String FirstName = rs.getString("visitorFirstName");
                        String LastName = rs.getString("visitorLastName");
                        String Password = rs.getString("visitorPassword");
                        String PhoneNumber = rs.getString("visitorPhone");
                        Email = rs.getString("visitorEmail");
                        ...
                        session.setAttribute("visitorName", FirstName + " " + LastName);
                        ...
                        if (request.getParameter("saveProfile") != null) {
                            ...
                            PreparedStatement updatePs = con.prepareStatement("UPDATE visitor SET visitorPhone = ?, visitorPassword = ?, visitorFirstName = ?, visitorLastName = ? WHERE visitorEmail = ?");
        ...
        <div class="container">
            ...
            <%
                            ...
                            out.println("No visitor profile found.");
                        }
                        rs.close();
                        ps.close();
                        con.close();
                    ...
                    // If the session doesn't exist or visitorID is not set, redirect to the login page
